...
export function Footer() {
  return (
    <footer className="bg-white dark:bg-zinc-950 pt-16 pb-8 border-t border-zinc-200 dark:border-zinc-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-6 max-w-xs">
              The AI-powered hiring copilot built for modern recruitment teams. Find, evaluate, and hire the best candidates faster.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="font-semibold text-zinc-900 dark:text-zinc-100 mb-4">{category}</h3>
